...
activities.update({
    ...
    "Basketball Club": {
        "description": "Basketball drills, pickup games, and league play",
    ...
    "Drama Society": {
        "description": "Theater workshops, rehearsals, and stage productions",
        "schedule": "Wednesdays and Saturdays, 4:00 PM - 6:30 PM",
        "max_participants": 25,
